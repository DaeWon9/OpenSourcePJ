  ...
  ################ display check #######################
    ...
    while(entire_loop): # entire loop
        ...
        while(purchase_map):
            ...
            if (equip_green_canvas):
                green_canvas.item_draw(window,  character_x_pos_inp + 29, character_y_pos_inp + 81)
            if (equip_blue_canvas):
                blue_canvas.item_draw(window,  character_x_pos_inp + 29, character_y_pos_inp + 81)
            if (equip_red_canvas):
                red_canvas.item_draw(window,  character_x_pos_inp + 29, character_y_pos_inp + 81)
            ############### user info draw ################################
        ...
        while(safe_box_map):
            ...
            if (equip_green_canvas):
                green_canvas.item_draw(window,  character_y_pos + 29, character_y_pos + 81)
            if (equip_blue_canvas):
                blue_canvas.item_draw(window,  character_y_pos + 29, character_y_pos + 81)
            if (equip_red_canvas):
                red_canvas.item_draw(window,  character_y_pos + 29, character_y_pos + 81)
            ###############################################
            user_money_text = game_font.render("보유금액 : " + convert_money(user_money), True, (0, 0, 0))
