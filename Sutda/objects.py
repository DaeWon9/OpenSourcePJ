...
level_1 = Button(40, 96, "image\Level_1.jpg")
level_2 = Button(40, 176, "image\Level_2.jpg")
level_3 = Button(40, 256, "image\Level_3.jpg")
level_4 = Button(350, 96, "image\Level_4.jpg")
level_5 = Button(350, 176, "image\Level_5.jpg")
level_6 = Button(350, 256, "image\Level_6.jpg")
level_7 = Button(40, 96, "image\Level_7.jpg")
level_8 = Button(40, 176, "image\Level_8.jpg")
level_9 = Button(40, 256, "image\Level_9.jpg")
level_10 = Button(350, 96, "image\Level_10.jpg")
level_11 = Button(350, 176, "image\Level_11.jpg")
level_12 = Button(350, 256, "image\Level_12.jpg")
next_button = Button(770, 419, "image\다음_button.png")
back_button = Button(1, 419, "image\Back_button.png")

#image
level_2_lock = pygame.image.load("image\락.png")
level_3_lock = pygame.image.load("image\락.png")
level_4_lock = pygame.image.load("image\락.png")
level_5_lock = pygame.image.load("image\락.png")
level_6_lock = pygame.image.load("image\락.png")
level_7_lock = pygame.image.load("image\락.png")
level_8_lock = pygame.image.load("image\락.png")
level_9_lock = pygame.image.load("image\락.png")
level_10_lock = pygame.image.load("image\락.png")
level_11_lock = pygame.image.load("image\락.png")
level_12_lock = pygame.image.load("image\락.png")
